...
//		if(f==false) continue;
		...
		fclose(fp);
		system("C:/Users/maobochao/AppData/Local/Programs/Python/Python38/python.exe c:/Users/maobochao/Desktop/EOJÍÆ¼öÏµÍ³/Program/KnowledgeTracing/evaluation/run.py");
//		sleep(10);
